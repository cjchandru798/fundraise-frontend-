...
const InternDashboard: React.FC = () => {
  ...
  const handleToggleNotifications = () => {
    ...
    if (hasNewNotifications) {
      setHasNewNotifications(false); // Clear the red dot once opened
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50 px-4 py-10 flex justify-center">
      ...
      {/* 🔓 Logout Button */}
        ...
        {/* 🏅 Badge */}
        <div className="bg-yellow-50 border-l-4 border-yellow-500 rounded p-4 flex items-center gap-4">
...
const QuickAction = ({
  ...
  <button
    onClick={onClick}
    className="flex flex-col items-center bg-white p-4 border rounded-xl shadow hover:shadow-md transition"
  >
